            ...
            if (response.type === 'success') {
                ...
                for (var i = 0; i < response.data.list.length; i++) {
                    ...
                    var action =
                        ...
                        '  <a href="javascript:void(0);" class="point-cursor mobile_tooltip" data-toggle="tooltip" title="Take Payment" data-t-title="lang_settlement" onclick="PosnicPro.kothistory.proceed(\'' + row._id + '\')"><i class="feather icon-arrow-right-circle"></i></a>' +
                        '  <a href="javascript:void(0);" class="point-cursor mobile_tooltip" data-toggle="tooltip" title="Print Bill" data-t-title="lang_print_bill" onclick="PosnicPro.kothistory.print(\'' + row._id + '\')"><i class="feather icon-printer"></i></a>' +
