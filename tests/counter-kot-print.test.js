...
function setup() {
  const dom = new JSDOM('<div id="kot-print-feedback"></div><input type="checkbox" id="kot-counter-auto"><select id="kot-counter-width"><option>80</option><option>58</option></select>', { url: 'http://localhost/', runScripts: 'outside-only' });
