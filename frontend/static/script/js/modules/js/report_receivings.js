            ...
            PosnicPro.get(params, function (response) {
                ...
                PosnicPro.renderNoRecords('.reportpurchase_norecord', 'No Records on ' + dateRange);
                        ...
                        for (var i = 0; i < response.data.list.length; i++) {
                            ...
                            var trow = '<tr><td><i class="exploder"><span class="feather icon-plus-circle"></span></i></td> <td scope="row">' + row_no + '</td>  <td><a href="#/receivingreport/' + row._id + '" ><i data-toggle="tooltip" class="table_model_item mobile_tooltip" title="View Details" data-t-title="lang_view_details_2">' + row.receiving_id + '</i></a></td> <td class="export-date">' + updateDate + '</td> <td>' + row.supplier_name + '</td> <td class="text-right"><a class="sale_color" href="tel:' + row.supplier_phone + '">' + row.supplier_phone + '</a></td> <td class="export-total-item text-center">' + row.items.length + '</td> <td class="export-price text-right">' + currency + '&nbsp;<span class="number">' + row.items_total + '</span></td></tr><tr class="explode hide"><td style="background: #f9f8f8; display: none;" colspan="12"><table class="table table-striped" cellspacing="0" width="100%" id="receiving_report_' + row._id + '"><thead><tr><th><lang class="lang_item_name">Item name</lang></th><th class="text-center"><lang class="lang_sku_title">SKU</lang></th><th class="text-right"><lang class="lang_price_title">Price</lang></th><th class="text-right"><lang class="lang_qty_title">Qty</lang></th><th class="text-right">Tax [%]</th><th class="text-right"><lang class="lang_total_title">Total</lang></th></tr></thead><tbody></tbody></table></td></tr>';
