...
(function () {
    ...
    var ACTIONS = [
        ...
        {
            name: 'About Posnic', keywords: 'version build cache info support help about this till',
            visible: function () { return !!PosnicPro.versionBadge; },
            run: function () { PosnicPro.versionBadge.show(); },
        },
        {
